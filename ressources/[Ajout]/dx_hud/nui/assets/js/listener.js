...
window.onload = event => {
  ...
  window.addEventListener('message', function (event) {
    ...
    if (action == 'setHealth') {
      ...
      Circle.HealthIndicator.path.setAttribute('stroke', health ? 'rgb(155, 0, 255)' : 'rgb(255, 0, 0)');
    ...
    if (action == 'setStamina') {
      if (data) {
        ...
        Circle.StaminaIndicator.path.setAttribute('stroke', stamina < 0.1 ? 'rgb(255, 0, 0)' : 'rgb(155, 0, 255)');
    ...
    if (action == 'setVehicle') {
      if (data) {
        ...
        Circle.FuelIndicator.path.setAttribute('stroke', fuel > 0.15 ? 'rgb(155, 0, 255)' : 'rgb(255, 0, 0)');
    ...
    if (action == 'setVoice') {
      ...
      if (data == 'disconnected') {
        ...
        Circle.VoiceIndicator.path.setAttribute('stroke', data ? 'rgb(155, 0, 255)' : 'rgb(169, 169, 169)');
    ...
    if (action == 'setSeatbelt') {
      ...
      Seatbelt.style.color = data.buckled ? 'rgb(155, 0, 255)' : 'rgb(255, 100, 100)';
    }
