...
local Identity = function()
    if Identiter == false then
        Identiter = true
        Prenom, Nom, Sex, Taille, Data = "Non renseigné", "Non renseigné", "Non renseigné", "Non renseigné", "Non renseigné"
                ...
                while open do
                    RageUI.IsVisible(id, function()
                        ...
                        RageUI.Button("Prenom", nil, {RightLabel = Prenom}, Prenom2 , {
                            onSelected = function()
                                Prenom = KeyboardInput("Entrer votre prenom", "", 15)
                        ...
                        RageUI.Button("Nom", nil, {RightLabel = Nom}, Nom2, {
                            onSelected = function()
                                Nom = KeyboardInput("Entrer votre nom de famille", "", 15)
                        ...
                        RageUI.Button('Sexe', nil, {RightLabel = Sex}, Sex2, {
                            onSelected = function()
                                Sex = KeyboardInput("Entrer votre sex. (m/f)", "", 1)
                        ...
                        RageUI.Button('Taille', nil, {RightLabel = Taille}, Taille2, {
                            onSelected = function()
                                Taille = KeyboardInput("Entrer votre taille. (180)", "", 3)
                        ...
                        RageUI.Button('Date de naissance', nil, {RightLabel = Data}, Data2, {
                            onSelected = function()
                                Data = KeyboardInput("Entrer votre data de naissance. (01/01/1999)", "", 10)
