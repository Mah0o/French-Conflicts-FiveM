...
local valide = RageUI.CreateSubMenu(Perso, "Valider Personnage", " ")
        ...
        Citizen.CreateThread(function()
            while open do
                RageUI.IsVisible(Perso, function()
                    ...
                    RageUI.Button('~g~Valider mon personnage', nil, {RightLabel = "→→"}, true, {
                        onSelected = function()
                            RageUI.CloseAll()
                ...
                RageUI.IsVisible(subMenu1, function()
                    ...
                    RageUI.Button("Voyage", nil, {RightLabel = ""}, true, {
                        onSelected = function()
                            if IsPedMale(PlayerPedId()) then
                                TriggerEvent('skinchanger:getSkin', function(skin)
                                    local clothesSkin = {
                    ...
                    RageUI.Button("Discret", nil, {RightLabel = ""}, true, {
                        onSelected = function()
                            if IsPedMale(PlayerPedId()) then
                                TriggerEvent('skinchanger:getSkin', function(skin)
                                    local clothesSkin = {
