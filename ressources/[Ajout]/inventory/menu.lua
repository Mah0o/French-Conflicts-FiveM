	...
	if canUse then
		...
		if result then
			if type(result) == "table" then 
				drawSprite("commonmenu", result[1], intX + (intW / 2.15), intY, .02, .034, 0.0, result[2], result[3], result[4], 255)
			else
				drawSprite("commonmenu", result, intX + (intW / 2.15), intY, .02, .034, 0.0, 255, 255, 255, 255)
			end	
		end 
